...
(function(root, factory) {
   ...
   * @module models/TemperatureResponseSensors
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>TemperatureResponseSensors</code>.
   * @alias module:models/TemperatureResponseSensors
   * @class
   */
   ...
   * @param {module:models/TemperatureResponseSensors} obj Optional instance to populate.
   * @return {module:models/TemperatureResponseSensors} The populated <code>TemperatureResponseSensors</code> instance.
   */
