...
(function(root, factory) {
   ...
   * @module models/DriversSummaryResponseSummaries
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>DriversSummaryResponseSummaries</code>.
   * @alias module:models/DriversSummaryResponseSummaries
   * @class
   */
   ...
   * @param {module:models/DriversSummaryResponseSummaries} obj Optional instance to populate.
   * @return {module:models/DriversSummaryResponseSummaries} The populated <code>DriversSummaryResponseSummaries</code> instance.
   */
